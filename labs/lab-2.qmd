...
**Question 2 -- Create a histogram of the `dep_delay` variable from the `nycflights` data.** *Don't forget to give your visualization informative axis labels!*
...
*Choose the type of plot you believe is appropriate for visualizing the **distribution** of arrival delays. Don't forget to give your visualization informative axis labels!*
