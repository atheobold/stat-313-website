...
- If they say 16 is the flights that arrived early (second filter)

*Feedback:* You are on the right track! The 45 and the 16 refer to the size of the filtered dataset. You are correct that the 45 refers to the number of observations / rows / flights that satisfied the criteria you specified. In Question 1a, you used two numbers to describe the size of the dataset. What did that second number represent?
