...
*Feedback:* Yu need to be careful to include ALL of the variables that R believes are categorical. What data types did we say in class that categorical variables can have?
...
*Feedback:* Careful! You should note if not every forest type was observed for every type of channel.
