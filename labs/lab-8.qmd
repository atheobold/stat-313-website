...
**2. Using `scale_x_log10()` and `scale_y_log10()`, decide on what relationship between life expectancy and GDP per capita appears the most linear. There should only be _one_ plot for this problem!**
...
*Hint: This condition says the _rows_ of the dataset are independent of each other. Look at the rows of the dataset, is there any reason to believe there are relationships between the rows?*
