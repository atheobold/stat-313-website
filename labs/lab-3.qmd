...
**Question 11 -- Find the average length of Cutthroat trout from the different channel types (`unittype`). Be sure to use the `trout` dataset from Question 5!**
...
**Question 12 -- Find the average length of Cutthroat trout from the different channel types (`unittype`) *and* forest `section`. Be sure to use the `trout` dataset from Question 5!**
...
*Hint: Your response should directly compare the statistics you got in in Question 12 with the density ridges you saw in Question 9.*
