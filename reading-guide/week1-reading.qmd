...
What is an example of a variable recorded as a number which **is not** a
numerical variable?
...
True or False: If a study does have an explanatory and a response variable, that
means changes in the explanatory variable must **cause** changes in the response
variable.
...
- Someone must first be *chosen* to be in a study and refuse to participate in
...
question. Response bias is when those lies are **predictable** and 
**systematic** based on outside influences. An example would be surveying 
Cal Poly students and asking them if they have ever driven drunk. 
...
How are observations sampled when a researcher uses a stratified sampling 
method? 
...
How are observations sampled when a researcher uses a multistage sampling 
method? 
