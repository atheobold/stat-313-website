...
::: columns
::: {.column width="45%"}
![Çetinkaya-Rundel and Hardin, **Introduction to Modern Statistics**. <https://openintro-ims.netlify.app/>](course%20images/ims.png)
:::
...
::: {.column width="45%"}
![Ismay & Kim, **Modern Dive: Statistical Inference via Data Science**. <https://moderndive.com>](course%20images/modern_dive_cover.png)
:::
:::
...
::: columns
::: {.column width="30%"}
![`R` is the statistical software we will be using in this course (<https://cran.r-project.org/>)](course%20images/R.jpeg){width="50%"}
:::

::: {.column width="30%"}
![RStudio is the most popular way to interact with the `R` software. We will be interacting with RStudio through [Posit Cloud](https://posit.cloud/) (Posit is the company that owns RStudio). You will join the Stat 313 workspace, and then be able to access the course homework and lab assignments. We will be walking through this in the first week of lab!](course%20images/rstudio.png){width="75%"}
:::

::: {.column width="30%"}
![For questions of general interest, such as course clarifications or conceptual questions, please use the Class Discord Server. Refer to the Day One Class Setup materials for more information on how to effectively use this server.](course%20images/discord.jpeg){width="50%"}
:::
:::
...
I will set + / - grades based on how close you are to the next higher (or lower) letter grade. For example, if you meet all the criteria for an A but only completed 10 satisfactory labs and critiques, you would earn an A-.
...
You can submit **up to one** revised Lab Assignment or Critique per week, until Sunday, March 19 at 11:59 pm.
...
Every Sunday evening there will be an announcement on Canvas letting you know what is due over the next week, and the material we will be covering. The module for each week will be released on Friday by 5pm, so you can look over the content and see what the plan is for the week.
...
|                                                   |                                                                                           |
| **Manages team progress through the task**        | **Manages in-class report**                                                               |
|                                                   |                                                                                           |
| -   Leads discussion                              | -   Responsible for organizing and recording answers to the assignment during discussions |
|                                                   |                                                                                           |
| <!-- -->                                          | <!-- -->                                                                                  |
|                                                   |                                                                                           |
| -   Makes sure everyone understands the task      | -   Compiles a summary of the solutions discussed                                         |
|                                                   |                                                                                           |
| -   Checks in with group members                  | -   Sends summary to report edito**r**                                                    |
|                                                   |                                                                                           |
| -   Keeps the group moving forward                |                                                                                           |
+---------------------------------------------------+-------------------------------------------------------------------------------------------+
| **Report Editor**                                 | **Team Captain**                                                                          |
|                                                   |                                                                                           |
| **Manages out-of-class report**                   | **Manages team participation**                                                            |
|                                                   |                                                                                           |
| -   Asks professor [*team*]{.underline} questions | -   Encourages participation                                                              |
|                                                   |                                                                                           |
| <!-- -->                                          | <!-- -->                                                                                  |
|                                                   |                                                                                           |
| -   Reviews draft summary provided by reporter    | -   Enforces norms                                                                        |
|                                                   |                                                                                           |
| -   Solicits feedback from the team               | -   Brings conversation back if it deviates                                               |
|                                                   |                                                                                           |
| -   Shares summary with the team                  | -   Substitutes for absent roles                                                          |
|                                                   |                                                                                           |
...
There will be confidential peer evaluations completed every three weeks. I will use these to check-in on each group's dynamics and ensure that everyone feels their voice is being heard.
...
-   **January 16:** Martin Luther King, Jr. Day holiday, no classes are held
-   **January 17:** Classes follow a Monday schedule
-   **February 20:** Washington's birthday, no classess are held
-   **April 20**: Last day of classes
-   **March 20 - 24**: Final exams

Click [here](https://registrar.calpoly.edu/acad_cal) for the full Cal Poly academic calendar.
