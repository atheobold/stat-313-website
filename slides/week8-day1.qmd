...
> [*definition*: a distribution of the]{style="color: #000000;"} [*permuted statistics*]{style="color: #0F4C81;"} [from every]{style="color: #000000;"} [*permuted resample*]{style="color: #0F4C81;"}
...
A p-value summarizes the [**probability**]{style="color: #0F4C81;"} of obtaining a sample statistic [as or more extreme than what we observed]{.underline}, [**if the null hypothesis was true**]{style="color: #0F4C81;"}.
:::
...
> ["The probability of observing a slope statistic (for the relationship between stem length and stem dry mass) as or more extreme than what was observed is less than 1 in 1000, if there was no relationship between a sugar maple's stem length and stem dry mass.]{style="color: #0F4C81;"}
...
::: {style="font-size: 2em; color: #000000;"}
Suppose we obtained a p-value of 0.6.
:::
