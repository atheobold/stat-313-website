---
title: "`r emo::ji('microscope')` Simulation-Based Methods versus Theory-Based Methods"
format: 
  revealjs:
    theme: dark
    self-contained: true
...
Revisions will be accepted until Sunday, March 19.
:::

- Week 8: **two** revisions will be accepted
- Week 9: **one** revision will be accepted
- Week 10: **two** revisions will be accepted
