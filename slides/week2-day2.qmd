...
{r, echo = FALSE} evals \<- tibble( year = c(rep(2020, 2), rep(2021, 5) ), quarter = c(rep("Fall", 2), rep("Winter", 2), rep("Spring", 3) ), average = c(4.53, 4.36, 4.18, 4.24, 4.83, 4.41, 4) )

kable(evals) %\>% kable_styling(stripe_color = "light blue")
