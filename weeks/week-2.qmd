...
## `r emo::ji("book")` Textbook Reading
...
::: callout-tip
See Canvas for the Week 2 Reading Guides.
:::

## `r emo::ji("check")` Concept Quiz Questions
...
2.  To better decide what summary statistic we should use to summarize the departure delays it would be best to create a data visualization of the *distribution* of departure delays.
