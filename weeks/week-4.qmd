...
`r emo::ji("computer")` R Tutorial: 2 (submit completion screenshot on Canvas)

------------------------------------------------------------------------

# `r emo::ji("book")` Chapter Reading: Basic Regression
...
-   [Download the Chapter 5 reading guide (Word)](reading_guide/week4_reading_guide.docx)

-   [Download the Chapter 5 reading guide (HTML)](reading_guide/week4_reading_guide.html)

# `r emo::ji("check")` Concept Quiz: Basic Linear Regression -- Due Tuesday by noon
