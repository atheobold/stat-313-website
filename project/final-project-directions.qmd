...
In Lab 3 you learned how to make density ridge plots, the most recommended visualization for numerical and categorical variables. **For your project you are required to use density ridge plots.** If you are unsure how to accomplish this task, look back over Lab 3 and the [Week 3 R resources](/resources/week3.docx).
...
<!-- ::: callout-caution -->
<!-- # Fitting a two-way ANOVA additive model -->

<!-- **If you rejected** $H_0$ for either of your explanatory variables, your next step is to fit a two-way ANOVA additive model. -->
<!-- ::: -->
...
<!-- ::: callout-caution -->
<!-- # Fitting a two-way ANOVA interaction model -->

<!-- **If you rejected** $H_0$ for either of your explanatory variables in your additive model, your next step is to fit a two-way ANOVA interaction model. -->
<!-- ::: -->
